...
if (isset($_POST["sbmpr"])) {
    if ( pluspromo($_POST) > 0) {
        echo "<script>
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary" name="sbmpr">Submit</button>
                        </div>
                    </form>
                        ...
                        <tbody>
                          ...
                          <?php foreach ($promo as $pr ):?>
                            <tr>
                                <th scope="row"><?= $i++; ?></th>
                                <td><?= $pr["teks"]; ?></td>
                                <td><a href="editpromo.php?id=<?= $pr["id"]; ?>" class="btn-circle btn-success btn-sm"><i class="fas fa-pen"></i></a>
                                <a onclick="return confirm('Apakah kamu yakin ingin mengapus ini?')" href="deletepromo.php?id=<?= $pr["id"]; ?>" class="btn-circle btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
