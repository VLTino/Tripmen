...
$header = query("SELECT * FROM `headersewa` WHERE `id`=1");
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="kendaraan.php"><i class="fas fa-hat-cowboy-side"></i> Header Utama</a>
            ...
            <div id="content">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <?php endforeach; ?>
                        <button type="submit" class="btn btn-primary" name="sbmhdr">Edit</button>
                    </div>
