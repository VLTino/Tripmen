...
$header = query("SELECT * FROM `headerfasilitas` WHERE `id`=1");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-primary" name="bg">Edit</button>
                    </form><br>
                    ...
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary" name="fas">Submit</button>
                        </div>
                    </form><br>
                    ...
                    <table class="table table-striped table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><?= $i++;?></th>
                                <td><?= $fas["fasilitas"]; ?></td>
                                <td><a href="editfas.php?id=<?= $fas["id"]; ?>" class="btn-circle btn-success btn-sm"><i
                                            class="fas fa-pen"></i></a>
                                    <a onclick="return confirm('Apakah kamu yakin ingin menghapus ini?')"
                                        href="deletefas.php?id=<?= $fas["id"]; ?>" class="btn-circle btn-danger btn-sm"><i
