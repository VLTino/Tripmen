...
$id = $_GET["id"];
$sistem = query("SELECT * FROM `sistem` WHERE `id`=$id");
                ...
                <form action="" method="post">
                    <div class="form-group">
                        <?php foreach ($sistem as $sis):?>
                            <input type="hidden" name="id" id="" value="<?= $sis["id"]; ?>">
                        <textarea name="sistem" id="" cols="30" rows="10" class="form-control"><?= $sis["sistem"]; ?></textarea><br>
                        <?php endforeach; ?>
                        <button type="submit" name="sbmsistem" class="btn btn-primary">Edit</button>
                    </div>
                </form>
