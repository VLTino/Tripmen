...
$header = query("SELECT * FROM `headerbenefit` WHERE `id` =1");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  ...
                  <table class="table table-striped table-responsive-md">
                        ...
                        <tbody>
                           ...
                           <?php foreach ($benefit as $bnf): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editbenefit.php?id=<?= $bnf["id"];?>" class="btn-circle btn-success btn-sm"><i
                                                class="fas fa-pen"></i></a>
                                        <a onclick="return confirm('Apakah kamu yakin ingin mengapus ini?')" href="deletebenefit.php?id=<?= $bnf["id"];?>" class="btn-circle btn-danger btn-sm"><i
                    ...
                    <a href="inputbenefit.php" class="btn btn-primary">Tambah</a>
