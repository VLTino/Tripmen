...
$id = $_GET["id"];
$benefit = query("SELECT * FROM `benefit` WHERE `id`=$id");

if (isset($_POST["sbmbnf"])){
    if(editbnf($_POST)){
        echo "<script>
                  ...
                  <form action="" method="post"> 
                    <div class="form-group">
                        <?php foreach ($benefit as $bnf ):?>
                            <input type="hidden" name="id" id="" value="<?= $bnf["id"]?>">
                        Header
                        <input type="text" name="header" id="" class="form-control" value="<?= $bnf["header"]?>">
                        Teks
                        <textarea name="teks" id="" cols="30" rows="10" class="form-control"><?= $bnf["teks"]?></textarea><br>
                        <?php endforeach; ?>
                        <button type="submit" name="sbmbnf" class="btn btn-primary">Submit</button>
                    </div>
                  </form>
