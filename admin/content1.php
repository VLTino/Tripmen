...
$problem = query("SELECT * FROM `content1`");
$headerc1 = query("SELECT * FROM `hdrc1` WHERE `id`= 1");

if (isset($_POST["sbmhd"])){
    if(edithdrc1($_POST)){
        echo "<script>
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post">
                        <div class="form-group">
                            <input type="text" name="header" id="" class="form-control-file" value="<?= $hdrc1["header"]; ?>"><br>
                            <button type="submit" class="btn btn-primary" name="sbmhd">Edit</button>
                        </div>
                    </form>
                    <?php endforeach; ?>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($problem as $pr): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editc1.php?id=<?php echo $pr["id"]; ?>" class="btn-circle btn-success btn-sm"><i
                                                class="fas fa-pen"></i></a>
                                        <a onclick="return confirm('Apakah kamu yakin ingin mengapus ini?')" href="deletec1.php?id=<?php echo $pr["id"]; ?>" class="btn-circle btn-danger btn-sm"><i
