...
$id = $_GET["id"];
$agen = query("SELECT * FROM `agen` WHERE `id`=$id");
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <?php foreach ($agen as $ag):?>
                                <input type="hidden" name="id" id="" value="<?= $ag["id"]; ?>">
                            <p>Gambar</p>
                            <img src="../img/<?= $ag["gambar"]; ?>" alt="" srcset="" style="width:100px;height:100px;border-radius:50%;">
