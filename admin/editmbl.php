...
$id = $_GET["id"];
$mobil = query("SELECT * FROM `mobil` WHERE `id`=$id");
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="id" id="" value="<?= $mbl["id"];?>">
                            Gambar <br>
                            <img src="../img/<?= $mbl["gambar"];?>" alt="" srcset="" style="width:300px">
                            <input type="file" name="gambar" id="" class="form-control-file"><br>
                            Merk
                            <input type="text" name="merk" id="" class="form-control" value="<?= $mbl["merk"];?>"><br>
                            Nama
                            <input type="text" name="nama" id="" class="form-control" value="<?= $mbl["nama"];?>"><br>
                            Harga Sewa
                            <input type="text" name="harga" id="" class="form-control" value="<?= $mbl["harga"];?>"><br>
