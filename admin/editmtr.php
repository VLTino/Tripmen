        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h3>Tambah Daftar Mobil</h3>
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <?php foreach ($motor as $mtr):?>
                            <input type="hidden" name="id" id="" value="<?= $mtr["id"];?>">
                            Gambar <br>
                            <img src="../img/<?= $mtr["gambar"];?>" alt="" srcset="" style="width:300px">
                            <input type="file" name="gambar" id="" class="form-control-file"><br>
                            Merk
                            <input type="text" name="merk" id="" class="form-control" value="<?= $mtr["merk"];?>"><br>
                            Nama
                            <input type="text" name="nama" id="" class="form-control" value="<?= $mtr["nama"];?>"><br>
                            Harga Sewa
                            <input type="text" name="harga" id="" class="form-control" value="<?= $mtr["harga"];?>"><br>
                            <button type="submit" name="sbmmbl" class="btn btn-primary">Submit</button>
                            <?php endforeach; ?>
                        </div>
                    </form>
