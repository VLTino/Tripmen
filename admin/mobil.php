...
$header = query("SELECT * FROM `headersewamobil` WHERE `id` =1");
                  ...
                  <table class="table table-striped table-responsive-md">
                        ...
                        <tbody>
                           ...
                           <?php foreach ($mobil as $mbl): ?>
                                <tr>
                                    <th scope="row"><?= $i++; ?></th>
                                    <td><img src="../img/<?= $mbl["gambar"]; ?>" alt="" srcset="" style="width:100px;height:100px;">
                                    </td>
                                    <td>
                                    <?= $mbl["merk"]; ?>
                                    </td>
                                    ...
                                    <td>
                                        <a href="editmbl.php?id=<?= $mbl["id"];?>" class="btn-circle btn-success btn-sm"><i
                                                class="fas fa-pen"></i></a>
                                        <a onclick="return confirm('Apakah kamu yakin ingin mengapus ini?')" href="deletembl.php?id=<?= $mbl["id"];?>" class="btn-circle btn-danger btn-sm"><i
                    ...
                    <a href="inputmbl.php" class="btn btn-primary">Tambah</a>
