...
$id = $_GET["id"];
$testi = query("SELECT * FROM `testimonial` WHERE `id`=$id");
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <?php foreach ($testi as $ts):?>
                            <input type="hidden" name="id" id="" value="<?= $ts["id"]; ?>">
                        Gambar <br>
                        <img src="../img/<?= $ts["gambar"]; ?>" alt="" srcset="" style="width:100px;height:100px;border-radius:50%;">
                        <input type="file" name="gambar" id="" class="form-control-file"><br>
                        Teks
                        <textarea name="teks" id="" cols="30" rows="10" class="form-control"><?= $ts["teks"]; ?></textarea><br>
                        Nama
                        <input type="text" name="nama" id="" class="form-control" value="<?= $ts["nama"]; ?>"><br>
                        Kota Tempat Tinggal
                        <input type="text" name="tempat" id="" class="form-control" value="<?= $ts["tempat"]; ?>"><br>
                        Posisi :
                        <p style="color:red;margin:0;">Saat ini <?= $ts["posisi"]; ?></p>
