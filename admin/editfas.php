...
$id = $_GET["id"];
$fasilitas = query("SELECT * FROM `fasilitas` WHERE `id`=$id");
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="id" id="" value="<?= $fas["id"]; ?>">
                            <input type="text" name="teks" id=""class="form-control" value="<?= $fas["fasilitas"] ?>"><br>
                            <?php endforeach; ?>
