...
$header = query("SELECT * FROM `headersewamotor` WHERE `id` =1");
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="motor.php"><i class="fas fa-motorcycle"></i> Motor</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                  ...
                  <table class="table table-striped table-responsive-md">
                        ...
                        <tbody>
                           ...
                           <?php foreach ($motor as $mtr): ?>
                                <tr>
                                    <th scope="row"><?= $i++; ?></th>
                                    <td><img src="../img/<?= $mtr["gambar"]; ?>" alt="" srcset="" style="width:100px;height:100px;">
                                    </td>
                                    <td>
                                    <?= $mtr["merk"]; ?>
                                    </td>
                                    ...
                                    <td>
                                        <a href="editmtr.php?id=<?= $mtr["id"];?>" class="btn-circle btn-success btn-sm"><i
                                                class="fas fa-pen"></i></a>
                                        <a onclick="return confirm('Apakah kamu yakin ingin mengapus ini?')" href="deletemtr.php?id=<?= $mtr["id"];?>" class="btn-circle btn-danger btn-sm"><i
                    ...
                    <a href="inputmtr.php" class="btn btn-primary">Tambah</a>
