...
$header = query("SELECT * FROM `headersistem` WHERE `id`=1");
$sistem = query("SELECT * FROM `sistem`");

if (isset($_POST["sbmhs"])){
    if(edithsis($_POST)){
        echo "<script>
            ...
            <div id="content">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="header" id="" class="form-control" value="<?= $hdr["header"]; ?>"><br>
                        <?php endforeach; ?>
                        <button type="submit" name="sbmhs" class="btn btn-primary">Edit</button>
                    </div>
                </form>
                ...
                <form action="" method="post">
                    <div class="form-group">
                        <textarea name="sistem" id="" cols="30" rows="10" class="form-control"></textarea><br>
                        <button type="submit" name="sbmsistem" class="btn btn-primary">Submit</button>
                    </div>
                </form>
                        ...
                        <tbody>
                           ...
                           <?php foreach ($sistem as $sis): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editsistem.php?id=<?= $sis["id"];?>" class="btn-circle btn-success btn-sm"><i
                                                class="fas fa-pen"></i></a>
                                        <a onclick="return confirm('Apakah kamu yakin ingin mengapus ini?')" href="delete.php?id=<?= $sis["id"];?>" class="btn-circle btn-danger btn-sm"><i
